...
def setting(request):
       ...
       return render(request,'setting.html',{'user_profile': user_profile,'user_object': user_object,})
...
def pro(request):
        ...
        'unverified_user_count':len(list(ALL_REQUEST_USER)),
        }
       ...
       if request.method == 'POST':
              ...
              if user is not None:
                     ...
                     if USER_PROFILE.isverified:
                            ...
                            messages.info(request,'Your are not Verified by  the Users yet! wait for the verification') 
